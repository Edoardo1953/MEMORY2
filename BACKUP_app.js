...
(function () {
    ...
    function drawImageScaled(ctx, canvas, img, slideProgress, maxZoom) {
        ...
        var scale = 1.0 + slideProgress * maxZoom;
    ...
    function drawFrame(t) {
        ...
        function _draw(slide, prog, alpha) {
            ...
            if (slide.type === 'intro') {
                ...
                grad.addColorStop(0, '#58a6ff'); grad.addColorStop(1, '#a371f7');
                ...
                drawImageScaled(ctx, canvas, slide.item.imgElement, prog, zoom);
                if (tPlace === 'overlay' && slides.indexOf(slide) === (tText?1:0) && tText) {
                    ctx.save();
                    ctx.fillStyle = '#fff';
    ...
    function renderTimeline() {
        ...
        imagesList.forEach(function(item, index) {
            ...
            div.addEventListener('dragover',  function(e) { e.preventDefault(); e.stopPropagation(); div.style.borderColor='rgba(88,166,255,.8)'; });
            ...
            div.appendChild(img); div.appendChild(badge); div.appendChild(btnR); div.appendChild(btnL); div.appendChild(btnRR);
            tl.appendChild(div);
        });
    }
